...
# -> {"range": "range_list", "color": "color_list"}
# class CreateColorList():
#     def __init__(video_path, game_transition, label, targets):
#         self.video_path = video_path

# binarize(bgr_image) -> binary
# gray_image = cv2.cvtColor(image, cv2.COLOR_BGR2GRAY)
# _, binary = cv2.threshold(gray_image, binary_min, binary_max, cv2.THRESH_BINARY)

# 5の判定もこれでやるといいかも。まあとりあえず今のままでおけ
...
# find_means(split_images) -> color_mean_list_in_range
# split_images=[[image0, image1, ...], [image0, image1, ...], ...]
